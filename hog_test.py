...
''' Retrieving the number of detected and non-detected cases. '''
...
print("Number of True Positive images: ", true_pos,
      ...
      "\nAccuracy of HOG: ", report["accuracy"])
print("\n\n")
...
'''
    If you want to show the output image use the following the commands
    cv.imshow("Image", image)
    cv.waitKey(0)

    the first statement displays the image with the title of the image
    the second statment is the wait time before the next image is loaded
'''
